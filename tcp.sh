...
sh_ver="1.3.2"
github="raw.githubusercontent.com/CoiaPrant/Linux-NetSpeed/master"
...
startlotserver(){
	...
	bash <(wget --no-check-certificate -qO- https://raw.githubusercontent.com/CoiaPrant/lotServer/master/Install.sh) install
